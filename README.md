...
Este repositório contém projetos desenvolvidos em **Python** durante o **Curso de Ciência de Dados da DIO**, realizado em parceria com o **Santander**.  
Os projetos têm como foco a aplicação prática de conceitos fundamentais da área, como **manipulação de dados, ETL (Extração, Transformação e Carregamento), análise de dados e automação de processos**.

O objetivo principal é consolidar o aprendizado e construir um **portfólio prático**, demonstrando a capacidade de resolver problemas reais utilizando Python.
